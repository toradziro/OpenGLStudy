	...
	m_translationA(100.0f, 100.0f, 0.0f)
{
	...
	float positions[] =
	{
		-50.0f, -50.0f, 0.9f, 0.1f, 0.0f, 1.0f,	//-- vertex index 0
		50.0f, -50.0f, 0.9f, 0.1f, 0.0f, 1.0f,	//-- vertex index 1
		50.0f, 50.0f, 0.9f, 0.1f, 0.0f, 1.0f,	//-- vertex index 2
		-50.0f, 50.0f, 0.9f, 0.1f, 0.0f, 1.0f,	//-- vertex index 3

		200.0f, 200.0f, 0.0f, 0.2f, 0.8f, 1.0f,	//-- vertex index 4
		300.0f, 200.0f, 0.0f, 0.2f, 0.8f, 1.0f,	//-- vertex index 5
		300.0f, 300.0f, 0.0f, 0.2f, 0.8f, 1.0f,	//-- vertex index 6
		200.0f, 300.0f, 0.0f, 0.2f, 0.8f, 1.0f,	//-- vertex index 7
	};
	...
	m_vertexBuffer = std::make_unique<VertexBuffer>(positions, uint32_t(6 * 8 * sizeof(float)));
...
void TestBatchRendering::onUpdate(float dt)
{
}
